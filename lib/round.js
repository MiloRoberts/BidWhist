...
exports.takeKitty = function(user_id){
...
exports.pickCard = function(user_id, card_id){
    seat_number = users.getSeat(user_id)
...
exports.unpickCard = function(user_id, card_id){
    seat_number = users.getSeat(user_id)
...
exports.discardPicks = function(user_id){
    let seat_number = users.getSeat(user_id)
...
exports.takeTrick = function(user_id){
